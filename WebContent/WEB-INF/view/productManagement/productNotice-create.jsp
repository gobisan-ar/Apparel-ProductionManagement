...
<body>
						...
						<div class="row">
							...
							<div class="col-md-12 mt-lg-4 mt-4">
								<div
									...
									<h1 class="h3 mb-0 text-gray-800">Create New Product Notice</h1>
							...
							<div class="col-md-12 mt-3 mb-3">
								<div class="card">
									<div class="card-body px-4">
										<form action="productNotice-insert" method="post" class="row g-4 px-4" name="noticeForm" id="noticeForm">
											<input type="text" class="form-control" name = "productID" id="productID"  value="${product.productID}" readonly="readonly" hidden> 
											
											<div class="row mt-5">
												<div class="col-md-6">
													<label for="productTilte" class="form-label">Product:</label>
													<input type="text" class="form-control" name = "noticeTitle" id="noticeTitle" readonly="readonly" value="${product.productTitle} - ${product.productID}"> 
												</div>
											...
											<div class="row mt-5">
												<div class="col-md-6">
													...
													<input type="number" class="form-control"  name="prodQty" id="prodQty">
												</div>
											...
											<div class="row mt-5">
												<div class="col-md-6">
													...
													<input type="text" class="form-control" name = "estBudget" id="estBudget"> 
	...
	<script>
		...
		$('#prodQty').on('change', function (key) {
			...
			document.getElementById("verifyBudget").innerHTML = "Budget should be at least " + minBudget + " or reduce qunatity";
